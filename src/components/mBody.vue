              ...
              <div class="col-md-4">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3>全栈开发</h3>
                    <p>
                      您想个性化定制自己的程序？没问题。全栈开发课程会让您顺心顺手
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">整体解决方案</h3>
                    <p>
                      没有程序定制经验？您可以直接提出向我们需求，我们为您定制解决方案。
                    </p>
                  </div>
                </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">PHP程序定制</h3>
                    <p>PHP全栈，丰富的经验，强硬的实力胜过一切广告。</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">PHP程序二次开发</h3>
                    <p>
                      您想个性化定制别人的程序？没问题。二次开发课程让您顺心顺手
                    </p>
                  </div>
                </div>
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">网站运营托管</h3>
                    <p>专业团队为您提供一站式网站运营托管。</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">平面设计</h3>
                    <p>提供海量海报、邀请函、贺卡、logo、名片设计等服务。</p>
                  </div>
                </div>
                <div class="media">
                  <div class="media-left">
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="media">
                  ...
                  <div class="media-body">
                    <h3 class="media-heading">面试经验</h3>
                    <p>
                      如果您想要了解面试的相关知识，欢迎联系创始人进行咨询。
                    </p>
                  </div>
                </div>
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>
                      更多服务不便在这里赘述，详情<a href="#contact">联系我们</a
                      >以询问
                    </p>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <h1 class="section-title">
              优秀课程展示
              <p class="section-para">
                不向庸俗与臃肿妥协，不向低端与低劣低头，始终迎合求学者的需求
              </p>
            </h1>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <h1 class="section-title">
              联系我们
              <p class="section-para">
                让您的需求得到最快速的回复，让您的每一分钟都会得到最大价值的发挥。
              </p>
            </h1>
          </div>
        </div>
